<template>
  <el-dialog title="选择发布班级" :visible.sync="classChoice" width="950px">
    <div class="control">
            ...
            <div class="thiscontainer" style="align-content: center">
              ...
              <el-radio-group v-model="currentClassType" @change="classTypeChange">
                <p v-for="item in leftDataList" style="font-size: 15px;">
                  <el-tooltip v-if="item.typeName.length>=9" class="item" effect="dark" :content="item.typeName" placement="top-start">
...
export default {
  ...
  updated() {
    if (this.$refs.multip && this.pandfirst === '0') {
