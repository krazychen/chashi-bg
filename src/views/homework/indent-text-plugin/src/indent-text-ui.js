...
import indentLeft from '@ckeditor/ckeditor5-indent/theme/icons/outdent.svg'
import indentRight from '@ckeditor/ckeditor5-indent/theme/icons/indent.svg'
...
export class IndentTextUi extends Plugin {
  ...
  init() {
    ...
    editor.ui.componentFactory.add('indentLeft', locale => {
      ...
      const indentCommand = editor.commands.get(INDENT_TEXT_COMMAND)
      view.bind('isEnabled').to(indentCommand, 'isEnabled')
