<template>
  <div ref="commentElem" :class="classObj" :uuid="comment.tagParagraph" @click="focusOn">
        ...
        <div class="comment-content container">
          <div class="user-profile flex center">
            ...
            <template v-if="commentable">
              &middot; <el-button size="mini" type="text" @click.prevent="onStartEditing">编辑</el-button>
    ...
    <template v-else>
      <blockquote class="compact" v-html="ind" />
    </template>
  </div>
</template>
...
export default {
  ...
  watch: {
    comment(val) {
      this.tagComment = val.tagComment
      this.repeatComment = val.repeatComment
    }
  },
  computed: {
    ...mapGetters([
