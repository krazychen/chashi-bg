<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="tableData" style="width: 100%" :default-sort="{prop: 'date', order: 'descending'}" :row-class-name="tableRowClassName" @filter-change="fnFilterChangeInit" @sort-change="qaTimeSort">
      ...
      <el-table-column prop="teacherName" fixed label="老师昵称" align="center" />
      ...
      <el-table-column prop="qa_time" sortable="custom" label="提问时间" width="140">
        <template slot-scope="scope">
          {{ scope.row.qaTime }}
        </template>
      </el-table-column>
  ...
  data() {
    return {
      ...
      listQuery: {
        ...
        search: undefined,
        subjectTypeList: [],
        orders: [{ 'column': 'qa_time', asc: true }]
      },
      listLoading: false,
      items: undefined,
      activeName: 'first',
