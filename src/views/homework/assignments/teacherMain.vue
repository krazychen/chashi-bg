<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="tableData" style="width: 100%" :default-sort="{prop: 'date', order: 'descending'}" :row-class-name="tableRowClassName" @filter-change="fnFilterChangeInit" @sort-change="qaTimeSort">
      <el-table-column fixed sortable="custom" prop="audit_state" label="状态" width="100" :filters="filters" :filter-method="filterTag" filter-placement="bottom-end" column-key="statusList"> <!--:filters="filters" :filter-method="filterTag" filter-placement="bottom-end"-->
