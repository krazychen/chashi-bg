    ...
    createData() {
      ...
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          formData.append('syUrl', this.temp.syUrl)
          formData.append('syProKey', this.temp.syProKey)
          formData.append('sySname', this.temp.sySname)
          formData.append('sySid1', this.temp.sySid1)
          formData.append('sySid2', this.temp.sySid2)
          formData.append('sySid3', this.temp.sySid3)
